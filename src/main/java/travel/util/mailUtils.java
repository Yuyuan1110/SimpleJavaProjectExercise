...
public class mailUtils {
    ...
    public static Credential getCredentials(NetHttpTransport HTTP_TRANSPORT) throws IOException {
        // Load client secrets.
        InputStream in = mailUtils.class.getResourceAsStream(CREDENTIALS_FILE_PATH);
        if (in == null) {
    ...
    public void sendEmailTest() throws MessagingException, IOException {
        ...
        String context = "click following link to authentication \n http://localhost/activeUserServlet?active_code="+new Date().getTime();
        gmailer.SendEmail("z0975750027@gmail.com", "test", context);
    }
}
